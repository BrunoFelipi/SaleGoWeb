app.controller('pontoCtrl', function ($scope, $rootScope, $location, PontoService, $routeParams, $filter) {
    ...
    $scope.initMap = function () {
        ...
        var centro = new google.maps.LatLng(parseFloat($scope.ponto.latitude), parseFloat($scope.ponto.longitude));
        var cityCircle = new google.maps.Circle({
            title: $scope.ponto.endereco,
            strokeColor: '#FF0000',
            strokeOpacity: 0.8,
            strokeWeight: 2,
            fillColor: '#FF0000',
            ...
            map: map,
            center: centro,
            radius: Math.sqrt($scope.ponto.raioAlcance * 1000)
        });

        var content = "<html>" + $scope.ponto.descricao + '</html>';
