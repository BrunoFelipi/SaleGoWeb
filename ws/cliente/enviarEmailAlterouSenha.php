<?php
    ...
    $message .= "</head>";
    $message .= "<body>";
    $message .= "<p>Sua senha foi alterada com sucesso.</p>";
    ...
    $message .= "<a href='http://pcbnu006300/Cakes/#/' style='font-size:16px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:40px; width:100%; display:inline-block'>";
    $message .= "<span style='color: #FFFFFF'>Cake's</span>";
    $message .= "</a>";
    $message .= "</td>";
    $message .= "</tr>";
    $message .= "</table>";
